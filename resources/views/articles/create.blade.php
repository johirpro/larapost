            ...
            <div class="row">
                ...
                <div id="content" class="8u skel-cell-important">
                    <section>
                        ...
                        <form action="/article/store" method="POST" style="width: 100%;">
                            @csrf
                            <div class="field">
                            ...
                            <div class="control">
                                <input type="text" class="input" name="intro" id="intro">
                                @error('intro')
                            ...
                            <div class="control">
                                <textarea rows="3" class="input" name="body" id="body"></textarea>
                                @error('body')
